...
class TestSuite(unittest.TestCase):
    """ Class for tests based on the unittest module using example data"""

    def test_resistor_value(self):
        """ Function for tests based on the unittest module using example data"""
        ...
        input_data = resistor_networks.process_resistors(
                            "(6, [8, (4, [8, (4, [6, (8, [6, (10, 2)])])])])")
